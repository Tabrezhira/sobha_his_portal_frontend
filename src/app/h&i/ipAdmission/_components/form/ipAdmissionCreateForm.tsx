  ...
  function HospitalCreateForm(
    ...
    useEffect(() => {
      ...
      setForm((prev) => ({
        ...
        name: employee.employeeName || prev.name,
    ...
    const autoSaveEmployeeDetails = useCallback(async () => {
      if (!patientId && form.empNo.trim() && form.name.trim()) {
        try {
          const baseUrl = process.env.NEXT_PUBLIC_DROPDOWN_API_URL
          if (!baseUrl) return
    ...
    const buildPayload = (): CreateIpAdmissionInput => {
              ...
              <Card className="space-y-2 sm:col-span-2 lg:col-span-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    type="button"
                    variant="secondary"
                    onClick={() => setSecondaryDiagnosis((prev) => [...prev, ""])}
                  >
                    Add diagnosis
                  </Button>
                </div>
          ...
          <Card className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <Select
                  value={form.isolationOrRehabilitationRequired ? "Yes" : "No"}
                  onValueChange={(value) =>

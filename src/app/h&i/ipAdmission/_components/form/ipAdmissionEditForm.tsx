...
// Removed custom Select imports to use react-select
...
const CategorySelect = ({
  ...
  const options = useMemo(() => items.map(item => ({ label: item, value: item })), [items])

  // Ensure current value is included in options if it doesn't exist
  ...
  const selectedOption = useMemo(() =>
    displayOptions.find(opt => opt.value === value) || null
